...
{ //blatantly taken and modified from https://phppot.com/php/php-time-ago-function/
    $timestamp = $unix;
...
function DeletePost($database_folder, $uploads_folder, $board, $thread, $post, $secure_hash, $fileonly = false, $recent_replies = 5, $mod_delete = false, $mod_level = false)
{
